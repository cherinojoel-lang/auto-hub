        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <AnimatedElement delay={100}>
            <form onSubmit={handleSubmit} className="bg-background rounded-lg p-8 shadow-sm border border-neutral-200">
              ...
              {/* First Registration */}
              <div className="mb-6">
                <label htmlFor="firstRegistration" className="block text-sm font-medium text-foreground mb-2">
                  Erstzulassung
                </label>
                <input
              ...
              {/* Fuel */}
              <div className="mb-6">
                <label htmlFor="fuel" className="block text-sm font-medium text-foreground mb-2">
                  Kraftstoff
                </label>
                <select
                  id="fuel"
