...
export default function VehiclePage() {
  const { MANUFACTURER_OPTIONS, FUEL_OPTIONS } = React.useMemo(() => ({
    MANUFACTURER_OPTIONS: deriveManufacturerOptions(vehiclesData),
    FUEL_OPTIONS: deriveFuelOptions(vehiclesData)
  }), [vehiclesData]);
