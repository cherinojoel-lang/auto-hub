        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-2 text-primary font-bold text-sm sm:text-base hover:text-primary/80 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md p-1 -m-1"
          ...
          <div id="mobile-filters-container" className={`${showFilters ? 'block' : 'hidden'} md:block`}>
