...
export default function VehiclePage() {
  ...
  // ⚡ Bolt: Extracted repeated array derivation into a single variable to prevent redundant array allocations during render passes.
  const activeFiltersCount = [manufacturer, priceMax, driveType, maxMileage, yearFrom].filter(Boolean).length;
