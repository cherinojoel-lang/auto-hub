...
export default function VehicleDetailPage() {
  ...
  const loadVehicle = async () => {
    ...
    try {
      setIsLoading(true);
      const safeVehicles = Array.isArray(vehiclesData) ? vehiclesData : []; const data = safeVehicles.find((v: Vehicle) => v.id === id) || null;
      setVehicle(data);
      ...
      if (data) {
        updateMetaTags({
          ...
          canonicalUrl: `https://sldwrd-my-site-wgayakj9-energievergleich.wix-vibe-site.com/vehicles/${id}`,
