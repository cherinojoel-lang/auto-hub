...
export default function VehicleDetailPage() {
  ...
  const loadVehicle = async () => {
    ...
    try {
      ...
      // ⚡ Bolt Optimization: Replaced filter().slice() with a single-pass for...of loop
      // to break early and prevent unnecessary full array iterations and memory allocations
      const similar = [];
