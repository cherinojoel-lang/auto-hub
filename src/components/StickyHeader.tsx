          ...
          <div className="container mx-auto px-4 max-w-[100rem] h-full flex items-center justify-between">
            ...
            <div className="lg:hidden flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 text-foreground hover:text-secondary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary rounded-lg"
