              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={interestRate}
                    readOnly
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg bg-slate-50 text-slate-600 cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600"
                  />
                </div>
              </div>
