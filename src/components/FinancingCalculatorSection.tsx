          ...
          <div className="flex items-center justify-center">
            <div className="w-full bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                {/* Purchase Price */}
                <div>
                  <label htmlFor="kaufpreis" className="block text-sm font-medium text-slate-700 mb-2">
                    Kaufpreis (EUR)
                  </label>
                  <input
                    id="kaufpreis"
                  ...
                  <input
                    ...
                    value={purchasePrice}
                    onChange={(e) => setPurchasePrice(Number(e.target.value))}
                    aria-label="Kaufpreis anpassen"
                    className="w-full mt-2 h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-red-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600"
                  />
                </div>

                {/* Down Payment */}
                <div>
                  <label htmlFor="anzahlung" className="block text-sm font-medium text-slate-700 mb-2">
                    Anzahlung (EUR)
                  </label>
                  <input
                    id="anzahlung"
                ...
                {/* Loan Term */}
                <div>
                  <label htmlFor="laufzeit" className="block text-sm font-medium text-slate-700 mb-2">
                    Laufzeit (Monate)
                  </label>
                  <select
                    id="laufzeit"
                ...
                <div>
                  <label htmlFor="zinssatz" className="block text-sm font-medium text-slate-700 mb-2">
                    Zinssatz (%)
                  </label>
                  <input
                    id="zinssatz"
