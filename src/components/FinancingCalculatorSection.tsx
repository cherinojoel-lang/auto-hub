              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full mt-2 h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-red-600 focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:outline-none focus-visible:border-transparent"
                  />
                </div>
