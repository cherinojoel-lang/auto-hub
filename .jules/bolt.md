...
## 2024-05-24 - [Filter Iteration Optimization]
**Learning:** Chaining multiple `.filter()` calls on arrays causes unnecessary intermediate array allocations and multiple iterations over the collection, which degrades performance on large datasets.
