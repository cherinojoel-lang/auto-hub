...
## 2024-06-10 - Precalculate expensive function calls

**Learning:** Function calls containing regexes mapped over large datasets significantly degrade performance.

**Action:** Add caching layer `WeakMap` or evaluate regex outside of render loops.
