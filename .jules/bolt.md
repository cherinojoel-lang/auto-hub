...
## 2026-09-21 - [Memoize string matching in loops]
**Learning:** The getTransmission function was concatenating strings and executing regular expressions for every vehicle during the list render loop without caching.
**Action:** Use a WeakMap to cache purely derived object computations (like regex matches on vehicle text) to prevent redundant processing during React reconciliation.
