...
## 2024-07-29 - [Missing maxLength limits on form fields]
**Vulnerability:** Form fields lacked maxLength attributes, exposing the application to client-side Denial of Service (DoS) risks and buffer issues.
**Learning:** Unrestricted input fields can be exploited to crash the client or cause excessive processing. Always enforce length limits at the UI level.
**Prevention:** Consistently apply maxLength attributes to all user-facing <input> and <textarea> elements.
