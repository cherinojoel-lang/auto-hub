...
## 2026-09-23 - Accessible Form Validation
**Learning:** Custom form validation errors require explicit association via `aria-describedby`, `aria-invalid`, and `role="alert"` to ensure screen readers announce validation errors.
**Action:** Always link dynamic error messages directly to the corresponding input elements using explicit aria properties and IDs.
